                ...
                <div class="container-fluid px-4 py-4">
                    <nav aria-label="breadcrumb" class="mb-4">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><i class="fas fa-trash"></i> Delete User</li>
                        </ol>
                    </nav>
                            ...
                            <div class="delete-card">
                                <div class="delete-card-body">
                                    <div class="warning-section">
                                        ...
                                        <p>Once you delete this user, all associated data will be permanently removed from the system.</p>
                                    </div>
                                    ...
                                    <div class="info-section">
                                        ...
                                        <div class="info-item">
                                            ...
                                            <span class="info-value"><span class="badge bg-primary">${user.role.name}</span></span>
                                        </div>
                                    </div>

                                    <div class="alert alert-danger" role="alert">
                                        <i class="fas fa-exclamation-circle"></i> <strong>Are you absolutely sure?</strong> This will permanently delete the user and cannot be reversed.
                                    </div>
