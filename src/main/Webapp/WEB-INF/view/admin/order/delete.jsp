                                ...
                                <div class="container-fluid px-4 py-4">
                                    <nav aria-label="breadcrumb" class="mb-4">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"><i class="fas fa-trash"></i> Delete Order
                                            </li>
                                        </ol>
                                    </nav>
                                            ...
                                            <div class="delete-card">
                                                <div class="delete-card-body">
                                                    <div class="warning-section">
                                                        <h5><i class="fas fa-exclamation-circle"></i> Warning: This
                                                            Action Cannot Be Undone</h5>
                                                        <p>Once you delete this order, all associated data will be
                                                    ...
                                                    <div class="info-section">
                                                        ...
                                                        <div class="info-item">
                                                            ...
                                                            <span class="info-value"><span
                                                                    class="badge bg-warning text-dark">${newOrder.status}</span></span>
                                                        </div>
                                                        <div class="info-item">
                                                    ...
                                                    <div class="alert alert-danger" role="alert">
                                                        <i class="fas fa-exclamation-circle"></i> <strong>Are you
                                                            absolutely sure?</strong> This will permanently delete the
                                                        order and cannot be reversed.
                                                    </div>
