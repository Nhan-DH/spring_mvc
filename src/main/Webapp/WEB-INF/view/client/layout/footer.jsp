        ...
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="d-flex flex-column text-start footer-item">
                    ...
                    <a class="btn-link" href="#">Help Center</a>
                </div>
            </div>

            <div class="col-lg-3 col-md-6">
                <div class="d-flex flex-column text-start footer-item">
                    <h4 class="text-light mb-3">Customer Account</h4>

                    <a class="btn-link" href="#">My Account</a>
                    <a class="btn-link" href="#">Laptop Products</a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <p>Address: BachKhoa Hanoi University of Science and Technology, Vietnam</p>
                    <p>Email: hongnhan474747@gmail.com</p>
                    <p>Phone: 0979886834</p>
