                        ...
                        <div class="col-lg-8">
                            <div class="profile-card">
                                ...
                                <div class="profile-header">
                                    ...
                                    <h1 class="profile-name">${sessionScope.fullName}</h1>
                                    <p class="profile-email">${sessionScope.email}</p>
                                    ...
                                    <div class="info-section">
                                        ...
                                        <div class="info-row full">
                                            <div class="info-item">
                                                ...
                                                <div class="info-value">${sessionScope.phone ne null ?
                                                    sessionScope.phone : 'Not provided'}</div>
                                            </div>
                                        </div>
                                    </div>
